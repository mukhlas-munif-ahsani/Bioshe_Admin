...
import com.munifahsan.biosheadmin.models.Chat
import com.munifahsan.biosheadmin.models.ChatRoom
...
class ChatRoomActivity : AppCompatActivity() {
    ...
    private val dbChat = FirebaseFirestore.getInstance()
        .collection("CHAT")
    private var adapterChat: ChatFirestoreRecyclerAdapter? = null
...
//                finish()
    ...
    private fun getUser(id: String) {
         ...
         */
        Constants.USERS_DB.document(id).get().addOnSuccessListener {
            if (it.exists()){
