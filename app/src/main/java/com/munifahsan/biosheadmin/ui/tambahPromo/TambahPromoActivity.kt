...
import com.munifahsan.biosheadmin.databinding.ActivityTambahPromoBinding
...
class TambahPromoActivity : AppCompatActivity(), TambahPromoContract.View {
    private lateinit var mPres: TambahPromoContract.Presenter
    private lateinit var binding: ActivityTambahPromoBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTambahPromoBinding.inflate(layoutInflater)
        val view = binding.root
        setContentView(view)

        mPres = TambahPromoPresenter(this)
        mPres.createPromo()
    ...
    private fun customCompressImage() {
        actualImage?.let { imageFile ->
            lifecycleScope.launch {
                ...
                // Full custom
                compressedImage = Compressor.compress(this@TambahPromoActivity, imageFile) {
                    resolution(1280, 720)
                    quality(80)
