package com.munifahsan.biosheadmin.ui.daftarPermintaanDistributor
...
import com.munifahsan.biosheadmin.databinding.FragmentDaftarPermintaanDistributorBinding
import com.munifahsan.biosheadmin.models.Produk
import com.munifahsan.biosheadmin.models.RequestProduk
...
import com.munifahsan.biosheadmin.ui.detailPermitaanDistributor.DetailPermintaanDistributorActivity
...
class DaftarPermintaanDistributorFragment : Fragment() {

    private var _binding: FragmentDaftarPermintaanDistributorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarPermintaanDistributorBinding.inflate(layoutInflater, container,false)
    ...
    private fun showItem() {
        ...
        val query = rootRef.collection("REQUEST_PRODUK").whereEqualTo("distributorId", (activity as DetailDistributorActivity?)!!.getDistributorId())
    ...
    private inner class DaftarViewHolder(private val view: View) :
        ...
        fun setProduct(
            ...
            permintaanCard.setOnClickListener {
                val intent = Intent(activity, DetailPermintaanDistributorActivity::class.java)
    ...
    private inner class DaftarFirestoreRecyclerAdapter(options: FirestoreRecyclerOptions<RequestProduk>) :
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DaftarViewHolder {
            val view = LayoutInflater.from(parent.context).inflate(
                R.layout.item_permintaan_distributor,
                parent,
                false
            )
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DaftarPermintaanDistributorFragment().apply {
