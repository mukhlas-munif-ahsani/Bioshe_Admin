package com.munifahsan.biosheadmin.ui.daftarOrderPending
...
import com.munifahsan.biosheadmin.databinding.FragmentDaftarOrderPendingBinding
...
class DaftarOrderPendingFragment : Fragment() {

    private var _binding: FragmentDaftarOrderPendingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarOrderPendingBinding.inflate(inflater, container, false)
    ...
    private inner class ProductViewHolder(private val view: View) :
        ...
        fun setStatus(status: String, membayar: Boolean, dibayar: Boolean, diproses: Boolean, dikirim: Boolean, selesaiDikirim: Boolean, selesaiDiterima: Boolean) {
...
//            statusTxt.text = status
            ...
            statusCard.setCardBackgroundColor(ContextCompat.getColor(activity!!, R.color.kuning))
...
//            }
    ...
    private inner class TransaksiFirestoreRecyclerAdapter(options: FirestoreRecyclerOptions<Orders>) :
        ...
        override fun onBindViewHolder(
            ...
            productViewHolder.setStatus(ordersModel.orderStatus, ordersModel.membayar, ordersModel.dibayar, ordersModel.diproses, ordersModel.dikirim, ordersModel.selesaiDikirim, ordersModel.selesaiDiterima)
    ...
    companion object {
         ...
         * @return A new instance of fragment DaftarOrderPendingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DaftarOrderPendingFragment().apply {
