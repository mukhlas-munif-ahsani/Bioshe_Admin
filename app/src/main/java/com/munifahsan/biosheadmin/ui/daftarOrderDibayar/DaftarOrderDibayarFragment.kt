package com.munifahsan.biosheadmin.ui.daftarOrderDibayar
...
class DaftarOrderDibayarFragment : Fragment() {
    private var _binding: FragmentDaftarOrderDIbayarBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDaftarOrderDIbayarBinding.inflate(layoutInflater, container, false)
...
//            statusTxt.text = status
    ...
    companion object {
         ...
         * @return A new instance of fragment DaftarOrderDIbayarFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DaftarOrderDibayarFragment().apply {
