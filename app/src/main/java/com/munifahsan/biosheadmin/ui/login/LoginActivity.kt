package com.munifahsan.biosheadmin.ui.login
...
import com.munifahsan.biosheadmin.databinding.ActivityLoginBinding
        ...
        if (isValidForm(email, pass)) {
            ...
            auth.signInWithEmailAndPassword(email, pass)
                .addOnCompleteListener {
                    if (it.isSuccessful) {
                        Constants.ADMIN_DB.document(FirebaseAuth.getInstance().currentUser!!.uid)
